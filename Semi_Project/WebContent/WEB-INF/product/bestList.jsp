...
<script type="text/javascript">
	...
	function bestPage(start){
		...
		$.ajax({
			url:"/Semi_Project/product/bestPageJSON.go",
			data:{"cnt":cnt // 8
				,"start":start},
						...
						html += "<div class='card-deck mb-5'>" +
									"<div class='col-md-3 col-lg-3'>" +
								    	"<div class='card mb-3' style='width:255px; border:0px; padding:0px;'>"+
								    	 "<img src='/Semi_Project/images/"+ item.pimage + "' class='card-img-top'  style='height:340px;'alt='...'>" +
							   				"<div class='card-body'>" +
							     				"<a class='stretched-link' href = '/Semi_Project/product/productDetail.go?pseq="+item.pseq+"'></a>" +
